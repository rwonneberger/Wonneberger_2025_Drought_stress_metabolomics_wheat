...
NORDrought <- read.csv("//storage-al.slu.se/home$/rawo0001/My Documents/Projects/CresWheat/Data/2121TB_NorDrome1/NORDrome_analysis_report_2121TB.csv", header = TRUE, sep = ",")
...
directory="Results/LemnaTecPhenotyping_Exp1/"
